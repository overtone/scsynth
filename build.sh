...
docker build -t scsynth-fedora-25-x86 scsynth-fedora-25-x86
docker build -t scsynth-fedora-24-x86 scsynth-fedora-24-x86
docker build -t scsynth-fedora-23-x86 scsynth-fedora-23-x86
docker build -t scsynth-fedora-22-x86 scsynth-fedora-22-x86
docker build -t scsynth-fedora-21-x86 scsynth-fedora-21-x86
